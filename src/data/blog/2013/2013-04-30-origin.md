...
If you care to poke around the [code is on GitHub](https://github.com/dbushell/dbushell-Origin). Or you can see the [GitHub page](https://dbushell.github.io/dbushell-Origin/) for my starting [pattern library](https://dbushell.github.io/dbushell-Origin/origin.html). This doesn't include everything I consider a "best practice" and a lot of things aren't commented. Make of it as you will — just please don't include it in a _"10 new resources for developers"_ blog post!
