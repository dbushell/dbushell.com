...
It's a shame that tech companies are so intent on ignoring such potential these days. With patent and copyright wars nearing no end, what chance do we have of seeing the next open standard truly revolutionise the digital world? Like many others I had hopes for Twitter becoming _the_ underlying API for micro-communication. Well Twitter's API change killed that idea.
